...
public class Blue extends OpMode {
    ...
    private final Pose gate = new Pose(17, 67, Math.toRadians(270));
    ...
    private final Pose intake3Pose = new Pose(47, 35, Math.toRadians(180));
    private final Pose feed3Pose = new Pose(23, 35, Math.toRadians(180));
    private final Pose parkPose = new Pose(36, 85, Math.toRadians(180));
    ...
    public void buildPaths() {
        ...
        toShoot2 = follower.pathBuilder()
                ...
                .setLinearHeadingInterpolation(Math.toRadians(270), Math.toRadians(144))
                .build();
